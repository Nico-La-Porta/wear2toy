...
OPTUNA_RESULTS_PATH = os.path.join(REPORTS_DIR, 'kfold_results_Tcar_PTNnone_PTAalltrs_FTNnone_FTAnone.csv')
OPTUNA_HYPERPARAMS_PATH = os.path.join(REPORTS_DIR, 'best_hyperparameters_kfold_Tcar_PTNnone_PTAalltrs_FTNnone_FTAnone.csv')
...
FINAL_MODEL_PATH = os.path.join(MODELS_DIR, "best_model_kfold_final_Tcar_PTNnone_PTAalltrs_FTNnone_FTAnone.pkl")
...
plot_CM(
    ...
    figure_name="cm_final_kfold_Tcar_PTNnone_PTAalltrs_FTNnone_FTAnone_all_data_trainval",
...
test_loss, test_acc, test_f1 = train_with_cm.evaluate_model(
    ...
    figure_name=f"cm_holdout_kid_{KID_TEST}_final_eval_Tcar_PTNnone_PTAalltrs_FTNnone_FTAnone",
