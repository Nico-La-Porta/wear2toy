...
results_df.to_csv(os.path.join(REPORTS_DIR, 'kfold_results_inference_spoon_Tspoon_PTNmeanstd_PTAalltrs_FTNmeanstdonft_FTAalltrs.csv'), index=False)
...
best_hyperparameters_df.to_csv(
    os.path.join(REPORTS_DIR, 'best_hyperparameters_kfold_inference_spoon_Tspoon_PTNmeanstd_PTAalltrs_FTNmeanstdonft_FTAalltrs.csv'), 
    index=False
)
...
FINAL_MODEL_PATH = os.path.join(MODELS_DIR, "best_model_kfold_final_inference_spoon_Tspoon_PTNmeanstd_PTAalltrs_FTNmeanstdonft_FTAalltrs.pkl")
