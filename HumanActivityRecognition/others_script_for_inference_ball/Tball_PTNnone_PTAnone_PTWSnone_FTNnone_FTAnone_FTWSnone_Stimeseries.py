...
test_loss, test_acc, test_f1 = train_with_cm.evaluate_model(model, test_loader, figure_name= "cm_test_best_hyp_optuna_inference_ball_without_anything", save_confusion_matrix=True, save_f1_score= True,  labels_dict=labels_dict)
