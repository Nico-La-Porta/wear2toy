...
best_f1_score = train_with_cm.train(best_net, train_loader, test_loader, epochs=100, batch_size=best_batch_size, lr=best_lr, figure_name="model_dl_with_aug.png")

# Salva il miglior modello
model_save_path = os.path.join(MODELS_DIR, 'best_model_dl_with_aug.pth')
