...
def objective(trial):
    ...
    # Crea il modello con gli iperparametri suggeriti# Carica il modello preaddestrato
    model = DeepConvLSTM()
    ...
    best_f1_score = train_toys_with_cm.train(model, train_loader, test_loader, epochs=100, batch_size=batch_size, lr=lr)
