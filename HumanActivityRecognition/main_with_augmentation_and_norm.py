...
best_hyperparams_file = os.path.join(REPORTS_DIR, 'best_hyperparameters_dl_norm_without_sampler_augmented_4_classes.csv')
if os.path.exists(best_hyperparams_file):
    ...
    best_hyperparameters_df.to_csv(os.path.join(REPORTS_DIR, 'best_hyperparameters_dl_norm_without_sampler_augmented_4_classes.csv'), index=False)
    ...
    file_name = "optimization_history_dl_norm_without_sampler_augmented_4_classes.png"
...
figure_name = f"model_dl_norm_without_sampler_augmented_4_classes_train_and_val.png"
train_with_cm.train(
    best_model, 
    best_train_loader, 
    best_test_loader, 
...
best_f1_score = train_with_cm.train(best_net, complete_dataloader, epochs=100, batch_size=best_batch_size, lr=best_lr, figure_name="model_dl_norm_without_sampler_augmented_4_classes.png", validate=False, save_confusion_matrix=True)

# Salva il miglior modello
model_save_path = os.path.join(MODELS_DIR, 'best_model_dl_norm_without_sampler_augmented_4_classes.pth')
