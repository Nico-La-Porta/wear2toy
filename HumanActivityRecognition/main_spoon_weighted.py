...
def objective(trial):
    ...
    best_f1_score = train.train(net, train_loader, test_loader, epochs=100, batch_size=batch_size, lr=lr, patience=7, f1_average='weighted')
...
best_hyperparameters_df.to_csv(os.path.join(REPORTS_DIR, 'best_hyperparameters_spoon_without_sampler_weighted.csv'), index=False)
...
file_name = "optimization_history_spoon_without_sampler_weighted.png"
...
best_f1_score = train_with_cm.train(best_net, train_loader, test_loader, epochs=100, batch_size=best_batch_size, lr=best_lr, figure_name="model_spoon_without_sampler_weighted", patience=7, f1_average='weighted')

# Salva il miglior modello
model_save_path = os.path.join(MODELS_DIR, 'best_model_spoon_without_sampler_weighted.pth')
