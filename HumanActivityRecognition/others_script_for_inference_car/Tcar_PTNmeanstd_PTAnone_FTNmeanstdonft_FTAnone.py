...
OPTUNA_RESULTS_PATH = os.path.join(REPORTS_DIR, 'kfold_results_Tcar_PTNmeanstd_PTAnone_FTNmeanstdonft_FTAnone.csv')
OPTUNA_HYPERPARAMS_PATH = os.path.join(REPORTS_DIR, 'best_hyperparameters_kfold_Tcar_PTNmeanstd_PTAnone_FTNmeanstdonft_FTAnone.csv')
...
FINAL_MODEL_PATH = os.path.join(MODELS_DIR, "best_model_kfold_final_Tcar_PTNmeanstd_PTAnone_FTNmeanstdonft_FTAnone.pkl")
