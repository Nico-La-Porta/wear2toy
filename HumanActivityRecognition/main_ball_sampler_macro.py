...
best_hyperparameters_df.to_csv(os.path.join(REPORTS_DIR, 'best_hyperparameters_ball_with_sampler_macro.csv'), index=False)
...
file_name = "optimization_history_ball_with_sampler_macro.png"
