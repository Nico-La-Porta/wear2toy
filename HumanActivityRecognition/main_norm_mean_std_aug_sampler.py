...
BEST_MODEL_PATH = os.path.join(MODELS_DIR, "best_model_dl_norm_mean_std_aug_sampler.pkl")
BEST_SCORE_PATH = os.path.join(REPORTS_DIR, "best_score_dl_norm_mean_std_aug_sampler.txt")
best_hyperparams_file = os.path.join(REPORTS_DIR, 'best_hyperparameters_dl_norm_mean_std_aug_sampler.csv')
...
if os.path.exists(best_hyperparams_file):
    ...
    best_hyperparameters_df.to_csv(os.path.join(REPORTS_DIR, 'best_hyperparameters_dl_norm_mean_std_aug_sampler.csv'), index=False)
    ...
    file_name = "optimization_history_dl_norm_mean_std_aug_sampler.png"
...
plot_CM(
    ...
    figure_name="cm_train_best_hyp_optuna_dl_norm_mean_std_aug_sampler"
)
...
plot_CM(
    ...
    Y=Y_Test,
    batch_size=best_batch_size,
    figure_name="cm_test_best_hyp_optuna_dl_norm_mean_std_aug_sampler"
)
...
test_loss, test_acc, test_f1 = train_with_cm.evaluate_model(model, complete_dataloader, figure_name= "cm_final_eval_best_hyp_optuna_dl_norm_mean_std_aug_sampler", save_confusion_matrix=True)
